...
$(document).ready(function () {
    ...
    var time_update_value = ['60', '720', '1440', '2880'];
    ...
    $(".site-title").text('© 2021 – Polychroma, LLC.');
    $(".site-url").html('<a href="https://polychroma.tv/privacy-policy/" target="_blank">Privacy Policy</a>');
});
