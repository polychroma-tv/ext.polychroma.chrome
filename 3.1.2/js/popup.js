/*
 ========================================
 Polychroma TV - Chrome Extension
 ----------------------------------------
 Copyright (c) 2021 – Polychroma, LLC.
 ----------------------------------------
 All rights reserved.
 ----------------------------------------
 https://polychroma.tv
...
$(document).ready(function () {
    ...
    if (config['site_url'] !== "") {
        var logo = $('#logo');
        logo.empty();
        logo.html('<a href="https://polychroma.tv" title="' + config['title'] + '" target="_blank"><img src="img/logo.svg"/></a>');
    }
...
function getContent(feed_id, feed_url, feed_type, feed_more_button, feed_socials, feed_description, feed_image, feed_image_type) {
    ...
    $.get(feed_url, function (data) {
        ...
        $(data).find(item).each(function () {
            ...
            var img = item_img;
            img = (!img) ? "/img/img.offline.gif" : img;
            if (feed_image == "show") {
            ...
            var html;
            html = '<li ' + read + '><a href="' + url + '" data-applink="polychroma://' + url + '" data-id="' + news_id + '" class="link">' + img +
            ...
            $(".news:not(.type-small) .feed li:nth-child(20)").hover(function() {
	            $(this).siblings().css( "transform", "translateY(-160px)");
		    ...
		    $('.type-small .feed li:nth-child(1)').click(function(){
			    $( ".type-small .feed li" ).slice( 2, 12 ).toggle();
			
			    var localVisible = $( ".type-small .feed li" ).slice( 2, 12 ).is(":visible"); 
			    localStorage.setItem('localVisible', localVisible);
			});
			
			
			$('.type-small .feed li:nth-child(13)').click(function(){
			    $( ".type-small .feed li" ).slice( 14, 30 ).toggle();
			
			    var newsVisible = $( ".type-small .feed li" ).slice( 14, 30 ).is(":visible"); 
			    localStorage.setItem('newsVisible', newsVisible);
			});
			
			
			$('.type-small .feed li:nth-child(31)').click(function(){
			    $( ".type-small .feed li" ).slice( 32, 52 ).toggle();
			
			    var entVisible = $( ".type-small .feed li" ).slice( 32, 52 ).is(":visible"); 
			    localStorage.setItem('entVisible', entVisible);
			});
			
			$('.type-small .feed li:nth-child(53)').click(function(){
			    $( ".type-small .feed li" ).slice( 54, 72 ).toggle();
			
			    var exploreVisible = $( ".type-small .feed li" ).slice( 54, 72 ).is(":visible"); 
			    localStorage.setItem('exploreVisible', exploreVisible);
			});
			
			$('.type-small .feed li:nth-child(73)').click(function(){
			    $( ".type-small .feed li" ).slice( 74, 94 ).toggle();
			
			    var lifestyleVisible = $( ".type-small .feed li" ).slice( 74, 94 ).is(":visible"); 
			    localStorage.setItem('lifestyleVisible', lifestyleVisible);
			});
			
			$('.type-small .feed li:nth-child(95)').click(function(){
			    $( ".type-small .feed li" ).slice( 96, 114 ).toggle();
			
			    var natureVisible = $( ".type-small .feed li" ).slice( 96, 114 ).is(":visible"); 
			    localStorage.setItem('natureVisible', natureVisible);
			});
			
			$('.type-small .feed li:nth-child(115)').click(function(){
			    $( ".type-small .feed li" ).slice( 116, 133 ).toggle();
			
			    var musicVisible = $( ".type-small .feed li" ).slice( 116, 133 ).is(":visible"); 
			    localStorage.setItem('musicVisible', musicVisible);
			});
			
			var localVisible = localStorage.getItem('localVisible') === 'false' ? false : true;
			$( ".type-small .feed li" ).slice( 2, 12 ).toggle(localVisible);
			
			var newsVisible = localStorage.getItem('newsVisible') === 'false' ? false : true;
			$( ".type-small .feed li" ).slice( 14, 30 ).toggle(newsVisible);
			
			var entVisible = localStorage.getItem('entVisible') === 'false' ? false : true;
			$( ".type-small .feed li" ).slice( 32, 52 ).toggle(entVisible);
			
			var exploreVisible = localStorage.getItem('exploreVisible') === 'false' ? false : true;
			$( ".type-small .feed li" ).slice( 54, 72 ).toggle(exploreVisible);
			
			var lifestyleVisible = localStorage.getItem('lifestyleVisible') === 'false' ? false : true;
			$( ".type-small .feed li" ).slice( 74, 94 ).toggle(lifestyleVisible);
			
			var natureVisible = localStorage.getItem('natureVisible') === 'false' ? false : true;
			$( ".type-small .feed li" ).slice( 96, 114 ).toggle(natureVisible);
			
			var musicVisible = localStorage.getItem('musicVisible') === 'false' ? false : true;
			$( ".type-small .feed li" ).slice( 116, 133 ).toggle(musicVisible);
